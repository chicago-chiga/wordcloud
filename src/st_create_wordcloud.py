...
def main():
    ...
    st.sidebar.write('user_dic: ', user_dic)
    ...
    st.sidebar.write('font_file: ', font_file)
    ...
    st.write('input_txt_file: ', input_txt_file)
    ...
    if start:
        ...
        # Todo:カウントファイルは後で考える
        # count_word = mw.count_word(
        #     split_file_path, top_rank, tmp_user_dic.name, udic_type, dname)
        # st.write('count_word_list: ', count_word_list)
